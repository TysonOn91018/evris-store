...
const rootFiles = new Set(['cloudinary-config.js','product-image-upload.js','member-favorites.js','coupon-sync.js','member-coupons.js','admin.html','admin.css','admin.js','inventory-model.js','catalog-live.js','index.html','products.html','product.html','styles.css','script.js','account-auth.js','auth-feedback.js','firebase-config.js','firebase-backend.js','homepage-motion.js','products-data.js','products-page.js','product-page.js']);
